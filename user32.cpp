...
// Window stubs
__declspec(dllexport) HWND GetDesktopWindow() { return (HWND)1; }
__declspec(dllexport) HWND GetActiveWindow() { return (HWND)1; }
__declspec(dllexport) HWND GetTopWindow(HWND) { return (HWND)1; }
__declspec(dllexport) HWND GetWindow(HWND, UINT) { return (HWND)1; }
__declspec(dllexport) LONG GetWindowLongA(HWND, int) { return 0; }
__declspec(dllexport) LONG_PTR GetWindowLongPtrA(HWND, int) { return 0; }
__declspec(dllexport) void GetWindowThreadProcessId(HWND, DWORD*) {}
...
// MessageBox
__declspec(dllexport) int MessageBoxA(HWND, LPCSTR text, LPCSTR caption, UINT) {
    pOutputDebugStringA("[MessageBox] ");
    pOutputDebugStringA(caption);
    pOutputDebugStringA(": ");
    pOutputDebugStringA(text);
    pOutputDebugStringA("\n");
    return 1;
}
